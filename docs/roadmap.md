...
- [x] Character database (206 characters with PVP stats, burst gen, release dates, PVP tier ratings)
...
#### Roster Import
Import owned characters from game screenshots via OCR, or from community tools that export roster data. Reduces manual selection of 206 characters.
